...
/*
 * Plugin Name: ES Dynamic Pricing Cart Line Item Blocks for WooCommerce
 * Plugin URI: https://github.com/lucasstark/es-dynamic-pricing-category-blocks
 * Description: WooCommerce Dynamic Pricing Category Blocks for WooCommerce creates block based pricing based on the cart line item index.  Note: Blocks and adjustment amounts are hardcoded in this plugin.
 * Version: 1.0.0
 * Author: Lucas Stark
...
class ES_Dynamic_Pricing_Cart_LineItem_Blocks {
	...
	public static function register() {
		if ( self::$instance == null ) {
			self::$instance = new ES_Dynamic_Pricing_Cart_LineItem_Blocks();
		}
	}
...
ES_Dynamic_Pricing_Cart_LineItem_Blocks::register();